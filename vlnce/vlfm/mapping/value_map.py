...
from vlnce.vlfm.mapping.base_map import BaseMap
from vlnce.utils.geometry_utils import extract_yaw, get_rotation_matrix
from vlnce.utils.img_utils import (
...
class ValueMap(BaseMap):
    ...
    def __init__(
        ...
        if PLAYING:
            size = 2000
        super().__init__(size, pixels_per_meter=pixels_per_meter)
